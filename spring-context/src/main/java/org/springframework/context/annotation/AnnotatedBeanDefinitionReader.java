...
public class AnnotatedBeanDefinitionReader {
	...
	private <T> void doRegisterBean(Class<T> beanClass, @Nullable String name,
		 ...
		 */
		AnnotationConfigUtils.processCommonDefinitionAnnotations(abd);// 根据判断是否有Lazy DependsOn Primary Role等这些注解来相应设置AnnotatedBeanDefinition中的属性值
		 ...
		 */
		// BeanDefinitionHolder没有实际作用，只是将beanDefinition和beanName封装为了一个map，是一个过渡变量
